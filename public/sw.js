/* Офлайн-режим dvoeplay.
   ...
   Все девять игр и главный экран — обычные файлы, поэтому после первого
   ...
   девятая игра). Для обычной правки игры ничего менять не нужно: файл
   обновится в кеше сам. */

const VERSION = 'dvoeplay-v4';
